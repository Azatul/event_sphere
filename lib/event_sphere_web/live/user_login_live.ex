defmodule EventSphereWeb.UserLoginLive do
  use EventSphereWeb, :live_view

  def render(assigns) do
    ~H"""
    <div class="bg-[#bcd2e4] min-h-screen flex items-center justify-center px-4">
      <div class="bg-white rounded-lg shadow-md p-8 w-full max-w-sm">
        <!-- Logo + Title -->
        <div class="flex items-center justify-center mb-6 text-center">
          <!-- Replace 'logo-6.png' with your actual logo path -->
        ...
        <.simple_form for={@form} id="login_form" action={~p"/users/log_in"} phx-update="ignore">
          ...
          <:actions>
            <.button phx-disable-with="Logging in..." class="block w-full py-2 rounded-md bg-[#224179] text-white hover:bg-[#19345c] transition font-semibold">
              Log Masuk
            </.button>
          </:actions>
        </.simple_form>
